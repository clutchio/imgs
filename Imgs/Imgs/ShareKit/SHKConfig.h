...
#define SHKMyAppName			@"Imgs"
#define SHKMyAppURL				@"http://imgsapp.com"
...
#define SHKFacebookAppID      @"111163632339814"
 ...
 */
#define SHKTwitterConsumerKey		@"Xk5whnyse93Wwq3D2OhIA"
#define SHKTwitterSecret			@"m7msVkaVkKuBF5h6tJ2j7o4FbzHqjieZFhVX3Z8"
#define SHKTwitterCallbackUrl		@"http://imgsapp.com/twitter-final/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
